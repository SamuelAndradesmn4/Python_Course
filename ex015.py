...
print('O modelo do Carro é {}.'.format(modelo))
print('A placa do Carro é:{}'.format(placa))
print('O carro foi alugado em: {}.'.format(data))
print('A quantidade de Km rodados é: {}'.format(km))
